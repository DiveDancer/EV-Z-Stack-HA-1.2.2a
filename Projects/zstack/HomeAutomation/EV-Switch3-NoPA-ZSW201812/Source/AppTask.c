...
void App_TaskInit( byte task_id )
{
  ...
  zclGeneral_RegisterCmdCallbacks( defEndPoint3, &Point3_CmdCallbacks );
  ...
  zcl_registerAttrList( defEndPoint3, Point3_NumAttributes, Point3_Attrs );
